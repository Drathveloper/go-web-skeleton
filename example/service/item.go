...
func (i *Item) ListItems(ctx context.Context) ([]domain.Item, error) {
...
func (i *Item) ListItemLookups(ctx context.Context) ([]domain.Item, error) {
...
func (i *Item) GetItemByID(ctx context.Context, id uint) (*domain.Item, error) {
	item, err := i.repository.FindItemByID(ctx, id)
	if err != nil {
		switch {
		case errors.Is(err, database.ErrRecordNotFound):
			return nil, fmt.Errorf(constants.DefaultWrappedErrorTemplate, getItemByIDErrMsg, domain.ErrItemNotFound)
		default:
...
func (i *Item) GetItemByIDSummary(ctx context.Context, id uint) (*domain.Item, error) {
...
func (i *Item) CreateItem(ctx context.Context, item *domain.Item) error {
...
func (i *Item) UpdateItem(ctx context.Context, item *domain.Item) error {
...
func (i *Item) DeleteItem(ctx context.Context, id uint) error {
